    ...
    <main className="flex lg:mt-20 flex-col lg:flex-row items-center justify-between min-h-[calc(90vh-6rem)]">
      ...
      >
        ...
        <p className="text-base sm:text-lg tracking-wider text-gray-400 max-w-[25rem] lg:max-w-[30rem]">
          The best way to reach uumas insted of spam folders, dlever
        ...
        <div className="flex gap-4 mt-12">
          ...
          >
            Documentation
            <i class="bxr  bx-arrow-out-up-right-stroke-square"></i>
          </a>
          <a
      ...
      <Spline
        ...
        className="absolute lg:top-0 top-[-20%] bottom-0 lg:left-[25%] sm:left-[-25%] h-full"
        scene="https://prod.spline.design/veAv6M6osbQiMiQB/scene.splinecode"
      />
    </main>
  );
};
